...
import com.example.autosmart.ui.adapter.SuggestionsAdapter;
import com.example.autosmart.model.MaintenanceSuggestion;
import com.example.autosmart.model.Vehicle;
import com.example.autosmart.network.ApiNinjasService;
...
public class DiagnosticFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inf,
        ...
        View v = inf.inflate(com.example.autosmart.R.layout.fragment_diagnostic, container, false);

        spinnerVehicles = v.findViewById(com.example.autosmart.R.id.spinnerVehicleDiag);
        btnFetch        = v.findViewById(com.example.autosmart.R.id.btnFetchDiag);
        rvSuggestions   = v.findViewById(com.example.autosmart.R.id.rvSuggestions);
