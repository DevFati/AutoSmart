...
public class DiagnosisFragment extends Fragment {
    ...
    private void showResult(DiagnosisResult result) {
        ...
        tvObdCode.setText("Código: " + result.code);
        tvObdDefinition.setText(result.definition);
        if (result.causes != null && !result.causes.isEmpty()) {
    ...
    static class DiagnosisResult {
        ...
        List<String> causes;
        DiagnosisResult(String code, String definition, List<String> causes) {
            this.code = code;
